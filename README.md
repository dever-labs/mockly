...
| **Rust** | `mockly-driver` | `mockly-testcontainers` | `mockly-driver = "0.13.0"` <!-- x-release-please-version --> or `mockly-testcontainers = "0.12.4"` in `[dev-dependencies]` |
...
<dependency>
  ...
  <version>0.13.0</version> <!-- x-release-please-version -->  <scope>test</scope>
</dependency>
```
...
steps:
  ...
  - name: Start Mockly
    uses: dever-labs/mockly/.github/actions/setup-mockly@v0.13.0 # x-release-please-version
    with:
...
integration-tests:
  ...
  variables:
    MOCKLY_VERSION: "v0.13.0" # x-release-please-version
